 ...
 *         &lt;element name="ShipmentOrder" type="{http://de.ws.intraship}ShipmentOrderDDType" maxOccurs="999"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "CreateShipmentDDRequest", namespace = "http://de.ws.intraship")
public class CreateShipmentDDRequest {
    ...
    protected List<ShipmentOrderDDType> shipmentOrders;
     ...
     * 
     */
    public List<ShipmentOrderDDType> getShipmentOrders() {
        if (shipmentOrders == null) {
            shipmentOrders = new ArrayList<ShipmentOrderDDType>();
        }
     ...
     *     
     */
    public void setShipmentOrders(List<ShipmentOrderDDType> shipmentOrders) {
